...
process () {
 ...
 if [ "$(wrote haveyou first)" = "true" ]; then
  ...
  if [ "$(wrote fucked)" = "true" ] || [ "$(wrote hadsex)" = "true" ] || [ "$(wrote madelove)" = "true" ]; then
 ...
 case $reader in
  ...
  areyouapirate)
   ...
   ;;
  areyouaactivist|areyouaartist|areyouamathematician|areyouamusician|areyouaphilosopher|areyouaphysicist|areyouapoet|areyouasage|areyouascientist|areyouawriter)
   echoes "ronin."
   process
   ;;
  ...
  areyouq|areyouqanon)
   ...
   ;;
  areyouavunit|areyoujester|areyouj3st3r|areyouj35t3r|areyouphineasfisher|areyouthejester|areyouth3j3st3r|areyouth3j35t3r)
   echoes "lol."
   process
   ;;
  wearelegion)
...
sights=("sunlight sparkling on the waves." "the moon glowing in the sky over the ocean." "the stars glittering in the sky over the ocean." "moonlight sparkling on the tidepools on the beach." "starlight sparkling on the tidepools on the beach." "beams of sunlight shining through the clouds onto the desert." "beams of sunlight shining through the clouds onto the field." "beams of sunlight shining through the clouds onto the forest." "beams of sunlight shining through the clouds onto the hills." "beams of sunlight shining through the clouds onto the marsh." "beams of sunlight shining through the clouds onto the meadow." "beams of sunlight shining through the clouds onto the mountains." "beams of sunlight shining through the clouds onto the orchard." "beams of sunlight shining through the clouds onto the pasture." "beams of sunlight shining through the clouds onto the swamp." "beams of sunlight shining through the clouds onto the tundra." "beams of sunlight shining through the clouds onto the vineyard." "lightning flickering through the clouds over the forest." "lightning flickering through the clouds over the marsh." "lightning flickering through the clouds over the meadow." "lightning flickering through the clouds over the swamp." "rain drizzling in the field." "rain drizzling in the orchard." "rain drizzling in the pasture." "rain drizzling in the vineyard." "fog drifting through the field." "fog drifting through the orchard." "fog drifting through the pasture." "fog drifting through the vineyard." "mist blowing through the field." "mist blowing through the orchard." "mist blowing through the pasture." "mist blowing through the vineyard." "snow falling in the field." "snow falling in the orchard." "snow falling in the pasture." "snow falling in the vineyard." "ice gleaming in the field." "ice gleaming in the orchard." "ice gleaming in the pasture." "ice gleaming in the vineyard." "sleet twinkling on the beach." "nuggets of hail melting in the sunlight on the beach." "ripples of meltwater shimmering on the beach." "waves splashing onto the beach." "seaweed rippling in the river." "ripples of pollen on the windowsill." "raindrops sparkling on the grass in the meadow." "dew glittering on the grass in the meadow." "frost gleaming on the grass in the meadow." "the grass in the meadow rippling with the wind." "the cattails by the dock rippling in the breeze." "the bamboo behind the mansion rippling with the wind." "the mangroves behind the cottage rippling with the wind." "the creosote behind the trailer rippling with the wind." "the sagebrush behind the trailer rippling with the wind." "flowers blooming on the cactuses behind the trailer." "the wind blowing wisps of seeds from the dandelions in the meadow." "dandelions flowering in the field." "dandelions flowering in the pasture." "dandelions flowering in the orchard." "dandelions flowering in the vineyard." "the buttercups flowering in the meadow." "the goldenrods flowering in the meadow." "the honeysuckle flowering in the meadow." "the marigolds flowering in the meadow." "the milkweed in the meadow rippling with the wind." "raindrops sparkling on the daisies in the meadow." "the roses blooming in the courtyard." "the lilacs blooming in the plaza." "flowers blooming on the cherry tree." "flowers blooming on the jacaranda tree." "flowers blooming on the kapok tree." "flowers blooming on the magnolia tree." "blossoms tumbling from the cherry tree." "blossoms tumbling from the jacaranda tree." "blossoms tumbling from the kapok tree." "blossoms tumbling from the magnolia tree." "ripples of pollen blowing down from the cedar trees in the forest." "fluffy seeds blowing down from the cottonwood trees in the dunes." "leaves budding on the cottonwood trees in the dunes." "leaves tumbling from the cottonwood trees in the dunes." "leaves budding on the aspen trees." "leaves budding on the birch trees." "leaves budding on the maple trees." "leaves budding on the oak trees." "leaves tumbling from the aspen trees." "leaves tumbling from the birch trees." "leaves tumbling from the maple trees." "leaves tumbling from the oak trees." "rain drizzling on the fir trees." "rain drizzling on the hemlock trees." "rain drizzling on the larch trees." "rain drizzling on the juniper trees." "rain drizzling on the pine trees." "rain drizzling on the ponderosa trees." "rain drizzling on the sequoia trees." "rain drizzling on the spruce trees." "rain drizzling on the ash tree behind the hotel." "raindrops dripping from the leaves of the baobab trees." "raindrops dripping from the leaves of the ginkgo trees." "raindrops dripping from the leaves of the banyan tree behind the villa." "raindrops dripping from the leaves of the eucalyptus trees on the beach." "raindrops dripping from the moss hanging from the cypress trees in the bayou." "puddles of rainwater shimmering around the roots of the sycamore tree." "the palm trees on the beach rippling in the breeze." "the willow trees along the stream rippling in the breeze." "a caterpillar crawling through the sunlight on the dock." "a butterfly fluttering through the sunlight by the dock." "sunlight shimmering on a chrysalis hanging in the window." "dragonflies flitting through the field." "dragonflies flitting through the orchard." "dragonflies flitting through the pasture." "dragonflies flitting through the vineyard." "fireflies shimmering in the field." "fireflies shimmering in the orchard." "fireflies shimmering in the pasture." "fireflies shimmering in the vineyard." "a grasshopper hopping through the yucca trees." "a bumblebee gliding around the hydrangeas in the garden." "a honeybee gliding around the azaleas in the garden." "hornets buzzing around a nest in the elm tree." "wasps buzzing around a nest in the beech tree." "an ant crawling across the window." "a ladybug crawling across the window." "sunlight shimmering on clouds of gnats in the meadow." "the shadows of the moths fluttering around the streetlamp flickering across the cobblestones in the street." "a spider clinging to a web glittering with dew." "a starfish clinging to a rock in the tidepools on the beach." "a snail crawling across a stump in the forest." "sunlight sparkling on the mussels on the rocks." "a crab scuttling around some driftwood on the beach." "sunlight sparkling on the barnacles on the rocks." "a frog hopping past the banyan tree." "a salamander perched on a boulder in the stream." "turtles basking in the sunlight in the sand on the beach." "a snake basking in the sunlight in the desert." "a gecko perched on the door of the taqueria across the street." "a chameleon perched in the sunlight on a boulder in the forest." "an iguana perched in the sunlight on a boulder on the beach." "a lizard perched in the sunlight on the balcony." "an alligator floating through the lilypads." "a crocodile floating through the lilypads." "a cockatoo flapping across the marsh." "ducks flapping across the tundra." "flamingos soaring across the lake." "a frigatebird flapping across the cove." "a gull perched on a rock by the tidepools on the beach." "a hawk soaring through the sky over the mesa." "a hummingbird flitting through the vines." "a heron gliding through the bayou." "a hornbill fluttering through the mist in the forest." "loons flapping across the ocean." "a lorikeet hopping across the veranda." "a macaw flapping across the swamp." "an owl flapping through the blizzard in the meadow." "a parakeet hopping across the balcony." "a parrot perched in the mangroves on the beach." "a peacock wandering through the fog in the forest." "pelicans gliding across the lagoon." "a pheasant wandering through the ferns in the forest." "a roadrunner darting through the sagebrush in the desert." "a robin perched in a nest of twigs." "a sparrow fluttering through the dunes." "starlings fluttering through the sky over the beach." "swans drifting in the river." "a toucan fluttering through the vines in the forest." "a tropicbird flapping across the bay." "a woodpecker fluttering through the forest." "bats fluttering through the moonlight in the forest." "bats fluttering through the starlight in the forest." "a mouse scurrying through the cactuses in the desert." "a chipmunk hopping through puddles of rainwater in the forest." "a squirrel hopping through puddles of rainwater in the forest." "a rabbit nibbling at some clover in the meadow." "an armadillo wandering through the rocks in the desert." "a beaver swimming through the sunlight in the river." "a badger wandering through the ferns in the forest." "a porcupine wandering through the ferns in the forest." "a raccoon wandering through the ferns in the forest." "a fox trotting through the thistles in the meadow." "a baboon wandering through the palm trees on the beach." "a bear drifting through the ferns in the forest." "a caribou drifting through the wildflowers in the meadow." "a deer drifting through the wildflowers in the meadow." "an elk drifting through the wildflowers in the meadow." "a moose drifting through the wildflowers in the meadow." "a boar drifting through the ferns in the forest." "a goat wandering through the acacia trees in the desert." "a donkey wandering through the creosote in the desert." "bison drifting across the meadow." "horses galloping across the meadow." "camels roaming through the dunes." "sheep wandering through the hills." "llamas drifting through the mountains." "yaks grazing in the meadow beneath the cliffs." "an otter floating in the river." "a seal flopping across the rocks along the ocean." "a manatee drifting past the dock." "dolphins jumping from the water in the ocean." "rainwater dripping from the thatch roof of the cabana." "puddles of rainwater shimmering in the courtyard." "puddles of rainwater shimmering in the plaza." "hail bouncing off the roof of the museum across the street." "hail bouncing off the roof of the theater across the street." "sleet twinkling in the courtyard." "sleet twinkling in the plaza." "sleet twinkling on the cobblestones in the street." "puddles of meltwater shimmering in the courtyard." "puddles of meltwater shimmering in the plaza." "puddles of meltwater shimmering on the cobblestones in the street." "sunlight sparkling on the glacier." "smoke rising from the rim of the volcano beyond the balcony of the hotel." "the fountain glittering in the plaza." "bonfires glowing on the beach." "sparklers flickering on the beach." "fireworks shimmering over the ocean." "the ivy on the greenhouse fluttering in the breeze." "the ivy on the barn behind the farmhouse fluttering in the breeze." "the ivy on the shed behind the townhouse fluttering in the breeze." "the ivy on the cafe across the street fluttering in the breeze." "laundry hanging from a clothesline on a balcony across the street." "laundry fluttering on a clothesline." "water rippling against the rowboat by the dock." "water rippling against the motorboat by the dock." "a taxi gliding through the fog." "a taxi gliding through the mist." "lights blinking on a yacht in the ocean." "lights blinking on a ship in the ocean." "a trolley rumbling through the neighborhood." "a train clattering through the neighborhood." "a jet soaring through the twilight over the ocean." "cars splashing through puddles of rainwater in the dusk below the balcony." "the lavender flowering on the balcony. sunlight sparkling on the waves." "the jasmine flowering on the balcony. sunlight sparkling on the waves." "the wisteria flowering on the balcony of the hotel. puddles of rainwater shimmering on the cobblestones in the street." "mosquitoes flying around puddles of rainwater on the porch. raindrops dripping from the mesquite trees in the desert." "a cardinal flitting through the forest. snow falling on the stream." "a chickadee flitting through the forest. ice gleaming on the stream." "a finch fluttering through the forest. sunlight glittering on the icicles. sunlight glittering on the snowdrifts. steam rising from the water in the onsen." "a myna perched on the balcony. a sailboat drifting toward the islands in the ocean. sunlight sparkling on the waves." "a myna perched on the balcony. a catamaran drifting across the reef in the ocean. sunlight sparkling on the waves." "a parrot perched on the balcony. lanterns glowing in the souk across the street." "pigeons fluttering through the rain. a radio glowing in a window across the street." "pigeons fluttering through the rain. a television glowing in a window across the street." "lightning flickering through the clouds. geese flapping across the tundra." "lightning flickering through the clouds. coyotes bolting across the desert." "the moon glowing in the sky. lamps shimmering in the windows of the izakaya across the street." "the moon glowing in the sky. lamps shimmering in the windows of the osteria across the street." "the stars glittering in the sky. lamps shimmering in the windows of the cantina across the street." "the stars glittering in the sky. lamps shimmering in the windows of the patisserie across the street." "rain drizzling in the darkness. a neon sign shimmering on the roof of the arcade. a vending machine glowing by the door in the alley." "rain drizzling in the street. a moped parked at the curb by the brasserie across the block." "rain drizzling in the street. a bicycle parked at the rack by the kissaten across the block." "lightning flickering through the clouds. a signal flashing on the steamboat in the harbor." "lightning flickering through the clouds. laundry flapping on a clothesline. candles glowing in the kitchen of an apartment across the street.")

sounds=("the ticking clock." "a breeze blowing through the desert." "a breeze blowing through the forest." "a breeze blowing through the meadow." "a breeze blowing through the tundra." "thunder rumbling through the clouds above the forest." "thunder rumbling through the clouds above the marsh." "thunder rumbling through the clouds above the meadow." "thunder rumbling through the clouds above the swamp." "thunder rumbling through the clouds. geese honking in the tundra." "thunder rumbling through the clouds. coyotes howling in the desert." "rainwater dripping from the thatch roof of the cabana." "hail pinging off the roof of the trailer." "waves splashing onto the beach." "the stream burbling in the forest." "the cottage creaking in the wind." "the mansion creaking in the wind." "the bamboo behind the cottage clacking in the wind." "the bamboo behind the farmhouse clacking in the wind." "the bamboo behind the inn clacking in the wind." "the bamboo behind the mansion clacking in the wind." "wind blowing through the cedar trees." "wind blowing through the fir trees." "wind blowing through the pine trees." "wind blowing through the spruce trees." "the aspen trees fluttering in the wind." "the birch trees fluttering in the wind." "the cherry trees fluttering in the wind." "the elm trees fluttering in the wind." "the juniper trees fluttering in the wind." "the maple trees fluttering in the wind." "the sycamore trees fluttering in the wind." "the willow trees fluttering in the wind." "the beech trees in the forest creaking in the wind." "the oak trees in the forest creaking in the wind." "rain drizzling on the ash trees." "rain drizzling on the jacaranda tree behind the ryokan." "rain drizzling on the kapok tree behind the villa." "rainwater dripping from the banyan tree onto the veranda." "a breeze blowing through the baobab tree behind the hotel." "a breeze blowing through the eucalyptus trees." "a breeze blowing through the mesquite trees." "cicadas humming in the field." "cicadas humming in the orchard." "cicadas humming in the pasture." "cicadas humming in the vineyard." "crickets chirping in the field." "crickets chirping in the orchard." "crickets chirping in the pasture." "crickets chirping in the vineyard." "a grasshopper chirping in the desert." "a chickadee chirping in the larch tree behind the cottage." "a frigatebird croaking in the mangroves." "a hawk crying in the sky above the mesa." "a heron squawking in the bayou." "a hummingbird zipping around the patio." "a parrot chirping in a banyan tree behind the mansion." "a robin chirping on a boulder in the meadow." "a woodpecker pecking at a sequoia tree." "an owl hooting in the forest." "cardinals twittering in the marsh. water rippling against the rowboat by the dock." "finches twittering in the swamp. water rippling against the motorboat by the dock." "ducks in the swamp." "swans in the marsh." "flamingos honking in the lagoon." "loons hooting in the darkness on the lake." "sparrows warbling in the tundra." "starlings twittering in the banyan tree." "tropicbirds shrieking in the sky above the cliffs." "the cry of a peacock in the forest." "a cockatoo whistling on the balcony. waves splashing onto the beach." "a hornbill squawking on the balcony. waves splashing onto the beach." "a macaw squawking on the balcony. waves splashing onto the beach." "a toucan whistling on the balcony. waves splashing onto the beach." "a frog chirping by the banyan tree behind the cottage." "frogs chirping in the marsh." "frogs chirping in the swamp." "rainwater dripping from the moss on the cypress trees. frogs chirping in the bayou." "a mouse squeaking under the porch." "a squirrel chirping in the forest." "camels grunting in the desert." "llamas humming in the pasture." "sheep bleating in the field." "a kettle rumbling on the stove. yaks grunting in the wildflowers behind the cottage." "a baboon hooting beneath the acacia tree." "bansuri. chattering. waves splashing onto the beach." "dulcimer. murmuring. waves splashing onto the beach." "parrots chirping in the twilight. sitar. tamboura. waves splashing onto the beach." "the fire crackling in the woodstove." "the wood crackling in the fireplace." "the humming of the fan." "a buoy clanging in the harbor." "a foghorn blowing in the harbor." "a horn blowing on a yacht in the ocean." "a horn blowing on a ship in the ocean." "a jet soaring through the sky over the ocean." "gulls squawking. a moped humming. a bell clanging in a cathedral up the block." "parakeets chirping. a bicycle chiming. a muezzin crooning in a mosque up the block." "rain drizzling on the palm trees. mynas chirping. gongs ringing in a temple down the block." "pigeons cooing. rain drizzling on the ginkgo trees. drums beating in a shrine down the block." "cars splashing through puddles of rainwater in the dusk below the balcony." "thunder rumbling through the clouds. a horn blowing on the steamboat in the harbor." "rain drizzling. tango playing over a stereo in a building across the block." "shouting. laughter. calypso playing over a stereo in a building across the block." "yelling. cheering. merengue playing over a stereo in a building across the block." "a parrot squawking on the balcony. salsa playing over a stereo in a building across the block." "a trolley rumbling through the neighborhood. samba playing over a stereo in a building across the block." "a train clattering through the neighborhood. mambo playing over a stereo in a building across the block." "a whistling kettle. whooping. muttering. applause. reggae playing over a stereo in a building across the block." "thunder rumbling through the clouds. laundry flapping on a clothesline. flamenco playing over a stereo in a building across the block." "lorikeets chirping. laundry fluttering on a clothesline. a taxi honking in the street." "a parrot squawking on the balcony. mumbling. chuckling. the lid thumping on a dumpster in the alley." "rain drizzling on the magnolia tree. keys jingling in the courtyard. luggage rattling across the cobblestones." "the cottonwood tree fluttering in a breeze. a ball bouncing in the plaza." "rain drizzling. a trumpet buzzing in the cafe across the street." "a piano tinkling in the parlor of a townhouse across the street." "a buzuq thrumming in the plaza." "a guitar thrumming in the plaza." "a mandolin thrumming in the courtyard." "a shamisen thrumming in the courtyard." "the buzzing of a trombone." "the buzzing of a tuba." "the warbling of a saxophone from a window across the street. radio advertisements. clinking pots." "television applause. jangling cutlery. the warbling of an oboe from a window across the street." "a clarinet warbling. murmuring at the izakaya across the street." "a koto warbling. chattering at the boulangerie across the street." "the fountain burbling in the courtyard." "a clocktower tolling.")
